...
### cat /dev/null > ./totalFile.csv
### totalFile=./totalFile.csv
cat /dev/null > ./totalFileNew.csv
totalFile=./totalFileNew.csv


declare -a fileNames
fileNames=()
fileNames=("./alllog_win_20240609.txt" "./alllog_win_20240616.txt" "./alllog_win_20240623.txt" "./alllog_win_20240630.txt")
...
### fileNames=("./alllog_win_20240602.txt")
...
for fileName in ${fileNames[@]}; do
	...
	do
		...
		domCntA=$(awk '{ print $2 }' "${oneLineFile}" | tee /dev/tty)
